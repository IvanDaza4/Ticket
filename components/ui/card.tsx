...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card/50 backdrop-blur-sm text-card-foreground flex flex-col gap-6 rounded-xl border-2 border-border/50 py-6 shadow-sm transition-all duration-300 hover:border-border/80',
        className,
      )}
      {...props}
    />
